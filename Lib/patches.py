...
PATCH_LIST = [
    ...
    Patch(name="Season 7", patch="7.17", start=datetime.date(2017, 8, 23), end=datetime.date(2017, 9, 13)),
    Patch(name="Season 7", patch="7.18", start=datetime.date(2017, 9, 13), end=datetime.date(2017, 9, 27))
]
